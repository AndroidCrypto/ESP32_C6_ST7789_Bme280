...
/*
TFT 240 x 320 pixels 2.0 inch ST7789 display wiring to an ESP32-C6 Supermini
...
const char *PROGRAM_VERSION = "ESP32-C6 Supermini ST7789 BME280 V01";
const char *PROGRAM_VERSION_SHORT = "ESP32-C6 ST7789 BME280 V01";
const char *DIVIDER = "--------------------";
